"""Adapter: RII-2025 SVM (train+dev, NE masked) — writes data/05_comparison/31_rii2025_svm_train_dev.json"""
import sys
...
NAME   = "RII-2025 SVM (train+dev)"
SOURCE = "python"
MODEL  = Path("compare/models/rii_2025/svm_char_word_train_dev.joblib")
OUT    = COMPARE_DIR / "31_rii2025_svm_train_dev.json"
