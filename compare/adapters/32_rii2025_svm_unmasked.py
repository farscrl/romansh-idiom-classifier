"""Adapter: RII-2025 SVM (train, NE unmasked) — writes data/05_comparison/32_rii2025_svm_unmasked.json"""
import sys
...
NAME   = "RII-2025 SVM (unmasked)"
SOURCE = "python"
MODEL  = Path("compare/models/rii_2025/svm_char_word_train_unmasked.joblib")
OUT    = COMPARE_DIR / "32_rii2025_svm_unmasked.json"
